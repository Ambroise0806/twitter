document.addEventListener('DOMContentLoaded', function () {
    ...
    function getTweet_withHashtag() {
        ...
        xhttp.open("GET", "hashtag.php", false)
    ...
    function getAllTweet() {
        const xhttp = new XMLHttpRequest()
        xhttp.open("GET", "tweet_hashtag.php", false)
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
                response = JSON.parse(this.responseText);
                tmp0 = response;
    ...
    function displayTweet(tweet_byHashtag, tmp0) {
        tweet_byHashtag.forEach(element => {
            console.log(tmp0[element-1])
            createTweet(h1, span2, span4, p)
            addContent(h1, span2, span4, p, tmp0[element-1][1], tmp0[element-1][2], tmp0[element-1][3], tmp0[element-1][4])
        });
    }
    displayTweet(tweet_byHashtag, tmp0);
    
    function createTweet(h1, span2, span4, p) {
    ...
    function addContent(container0, container1, container2, container3, content0, content1, content2, content3){
        container0.innerHTML = content0
