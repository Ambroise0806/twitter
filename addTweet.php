...
class Database
{
    ...
    public function getHashtag($content)
    {
        throw new InvalidArgumentException('retest');
        // $hashtag = [];
        // $array_content = explode("#", $content);
        // foreach ($array_content as $string) {
        //     if (str_starts_with("#", $string)) {
        //         array_push($hashtag, $string);
        //     }
        // }
        // throw new InvalidArgumentException($hashtag);
    }
