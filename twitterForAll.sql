...
DROP DATABASE IF EXISTS twitterForAll;

CREATE DATABASE twitterForAll;
...
CREATE TABLE `subscriptions` (
  ...
  `stopping_time` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tweet` (
  ...
  `id_quotedTweet` int DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `user` (
  ...
  `AtUsername` varchar(30) NOT NULL,
...
INSERT INTO `user` VALUES (1,'Syphax','@Syphax','img/lm5p.jpg','Salut ici cest le twitter de Syphax le plus beau','img/1265.jpg','SyphaxLPB@gmail.com','eie2151sfe48465','00:00:00',0,'2024-02-21 09:38:51','Paris',NULL),(2,'Romain','@ronron','img/3fgm.jpg','ici ça code','img/ab65.jpg','ronron@free.fr','ffqoh861e2151465','00:00:00',1,'2024-02-21 09:40:23','Paris',NULL);
...
-- Dump completed on 2024-02-21 15:17:00
