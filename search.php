...
<body class="bg-gray-200 dark:bg-gray-800">
    ...
    <button type="submit" id="searchBtnProfile" class="p-2.5 ms-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Search by profiles  
        <span class="sr-only">Search</span>
        </button>

        <button type="submit" id="searchBtnHashtag"class="p-2.5 ms-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Search by hashtags
            <span class="sr-only">Search</span>
        </button>
    <!-- Search by profiles -->
    ...
    <form class="flex items-center max-w-sm mx-auto">   
        ...
        <div class="relative w-full m-2">
            ...
            placeholder="Search by profiles or hashtags"/>
        </div>
        ...
        <div class="relative w-full m-2">
            ...
            <input type="text" id="searchHashtag" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
